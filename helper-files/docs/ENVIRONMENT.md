...
- `caller_env` originates from **`wrangler.api.toml`** of the Serverless API Gateway and contains its bindings, secrets, and service bindings. It is should be parsed as `JSON.parse(caller_env)` before use.
